...
import 'package:project_8_fav_places/screens/map.dart';
...
class _LocationInputState extends State<LocationInput> {
  ...
  void _savePlace(double latitude, double longitude) async {
    final url = Uri.parse(
      "https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyAcKZHMOpRIqKUPAAP1U-n8Vp6nEtg7pcs",
    );
  ...
  void _selectOnMap() async {
    ...
    _savePlace(pickedLoacation.latitude, pickedLoacation.longitude);
  }
